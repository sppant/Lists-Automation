			  ...
			  <tbody>
			    <tr>
			      ...
			      <td><?php echo $each['spot_date']; ?></td>
						...
						<td id='delete_row' >	<button type="button" class="btn btn-danger" onclick="window.location='<?php echo base_url("index.php/Spot_preview/delete_spot_on_preview/" .$each['spot_id'].'/'.$customer);?>'" >X</button></td>
			    </tr>
